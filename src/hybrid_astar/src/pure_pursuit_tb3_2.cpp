...
*/
	...
	listener_robot.waitForTransform("/map", "/tb3_2/base_link", ros::Time::now(), ros::Duration(1.0));

	/*tf::TransformListener listener_trailer;
	tf::StampedTransform transform_trailer;
	listener_trailer.waitForTransform("/map", "/tb3_2/base_link", ros::Time::now(), ros::Duration(2.0));*/
	...
	listener_obs_2.waitForTransform("/map", "/tb3_0/base_link", ros::Time::now(), ros::Duration(1.0));*/
...
//ros::Duration(0.05).sleep();
	...
	while(true) {
		...
		listener_robot.lookupTransform("/map", "/tb3_2/base_link", ros::Time(0), transform_robot);
		//listener_trailer.lookupTransform("/map", "/tb3_2/base_link", ros::Time(0), transform_trailer);
...
cout<<x_obs_2<<" "<<y_obs_2<<" "<<yaw_obs_2<<endl;
			...
			srv1.request.r_r=yaw_t;
				...
				cout<<"kl"<<endl;
				listener_robot.lookupTransform("/map", "/tb3_2/base_footprint", ros::Time(0), transform_robot);
