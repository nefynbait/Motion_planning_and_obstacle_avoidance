...
"""autogenerated by genpy from hybrid_astar/PathTracking.msg. Do not edit."""
import codecs
import sys
...
class PathTracking(genpy.Message):
  _md5sum = "828ba78ead1f8c45eb08d3a94a1d45c3"
  _type = "hybrid_astar/PathTracking"
...
"""
  ...
  _slot_types = ['nav_msgs/Path','int8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathTracking, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.direction = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
