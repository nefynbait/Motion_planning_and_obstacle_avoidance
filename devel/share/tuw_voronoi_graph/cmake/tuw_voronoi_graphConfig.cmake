...
if("TRUE" STREQUAL "TRUE")
  set(tuw_voronoi_graph_SOURCE_PREFIX /home/souvik/turtlebot/src/tuw_multi_robot/tuw_voronoi_graph)
  set(tuw_voronoi_graph_DEVEL_PREFIX /home/souvik/turtlebot/devel)
  ...
  set(tuw_voronoi_graph_INSTALL_PREFIX /home/souvik/turtlebot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tuw_voronoi_graph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/souvik/turtlebot/src/tuw_multi_robot/tuw_voronoi_graph/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND tuw_voronoi_graph_EXPORTED_TARGETS ${${tuw_voronoi_graph_dep}_EXPORTED_TARGETS})
endforeach()
