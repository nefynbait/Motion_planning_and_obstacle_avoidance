...
#include "../../../../../src/tuw_multi_robot/tuw_multi_robot_rviz/include/tuw_multi_robot_rviz/VoronoiGraphDisplay.h"
...
void tuw_multi_robot_rviz::VoronoiGraphDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VoronoiGraphDisplay *_t = static_cast<VoronoiGraphDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject tuw_multi_robot_rviz::VoronoiGraphDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<tuw_multi_robot_msgs::Graph>::staticMetaObject, qt_meta_stringdata_tuw_multi_robot_rviz__VoronoiGraphDisplay.data,
      qt_meta_data_tuw_multi_robot_rviz__VoronoiGraphDisplay,  qt_static_metacall, nullptr, nullptr}
};
